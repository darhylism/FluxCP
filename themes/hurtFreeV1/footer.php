					...
					<div class="columns is-centered">
						...
						<div class="column">
							...
							<nav class="level">
								...
								<div class="level-item">
									<a class="icon is-large" href="<?php echo $hurtsky['facebookLink'];?>" target="_blank">
								...
								<div class="level-item">
									<a class="icon is-large" href="<?php echo $hurtsky['discordInviteLink'];?>" target="_blank">
								...
								<div class="level-item">
									<a class="icon is-large" href="<?php echo $hurtsky['twitterLink'];?>" target="_blank">
